...
export default function CompaniesListPage() {
    ...
    const pageSize = 12;
    const { data, isLoading, isError } = useCompanies(page, pageSize, filters);
            ...
            <main className="max-w-7xl mx-auto px-6 py-24">
                <div className="mb-12">
                    ...
                    <p className="text-stone-600">
                        Khám phá {data?.data?.meta?.totalItems || 0} công ty hàng đầu đang tuyển dụng
                    </p>
                </div>
                ...
                {isLoading && (
                    <div className="flex items-center justify-center py-20">
                        ...
                        <span className="ml-3 text-stone-600">Đang tải danh sách công ty...</span>
                    </div>
                )}
                ...
                {!isLoading && !isError && data?.data?.result?.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-stone-500 text-lg">Không tìm thấy công ty phù hợp</p>
